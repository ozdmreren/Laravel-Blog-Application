  ...
  <form class="relative" id="blog_form" method="POST" action="/" enctype="multipart/form-data">
    ...
    <x-form-field >
      <div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg mt-10">
        ...
        <input type="text" id="blog_title" name="blog_title" placeholder="Enter your blog title"
            class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-400 mb-4" required value="{{old('blog_title')}}">
            ...
            <input type="text" id="sub_blog_title" name="sub_blog_title" placeholder="Descript your content"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-400 mb-4">
    ...
    <div id="image-preview" class="mt-4 hidden">
        ...
        <div class="border border-gray-300 rounded-md mt-2 p-4">
            ...
            <div >
              <textarea id="blog-content" name="blog_content" contenteditable="true" class="w-full p-2 min-h-[150px] border-none focus:outline-none text-gray-900 placeholder-gray-400">{{old('blog_content')}}</textarea>
              <x-error-input name="blog_content"/>
            </div>
        </div>
        
        <!-- Dropdown Menüsü KATEGORI ALANI
        <div class="relative inline-block text-left mt-4">
            <p id="dropdownButton" class="bg-slate-200 text-black px-4 py-2 rounded-lg shadow-md hover:bg-slate-300 transition select-none">
                Select Category
            </p>
        
            
            <div id="dropdownMenu" class="absolute left-0 mt-2 w-48 bg-white border rounded-lg shadow-lg hidden">
                <ul class="py-2 text-gray-700">
                    <li><a href="?category=egitim" class="block px-4 py-2 hover:bg-gray-200">📘 Education</a></li>
                    <li><a href="?category=hayat" class="block px-4 py-2 hover:bg-gray-200">🌍 Life</a></li>
                    <li><a href="?category=bilim" class="block px-4 py-2 hover:bg-gray-200">🔬 Science</a></li>
                    <li><a href="?category=teknoloji" class="block px-4 py-2 hover:bg-gray-200">💻 Technology</a></li>
                    <li><a href="?category=sanat" class="block px-4 py-2 hover:bg-gray-200">🎨 Art</a></li>
                    <li><a href="?category=seyahat" class="block px-4 py-2 hover:bg-gray-200">✈️ Travel</a></li>
                </ul>
            </div>
        </div> -->
        <!-- Yayınla Butonu -->
