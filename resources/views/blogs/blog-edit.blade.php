<x-layout>
    <form method="POST" action="/blogs/{{$blog->id}}">
        ...
        <x-form-field >
          <div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg mt-10">
            ...
            <input type="text" id="blog_title" name="blog_title" placeholder="Enter your blog title"
                class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-400 mb-4" value="{{$blog->blog_title}}">
        ...
        <div id="image-preview" class="mt-4 hidden">
            ...
            <!-- Yayınla Butonu -->
            <button type="submit" class="mt-6 w-full bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition">
                Update blog
            </button>
        </div>
        </x-form-field>  
